...
#Cache Block Size Loop
				...
				do
					...
					echo "$T: L1 Cache D-size =${L1D_cachesize[$L1D]}kB, L1 Cache I-size=${L1I_cachesize[$L1I]}kB, L1 D-Asso=${L1D_associativity[$L1DAso]}, L1 I-Asso=${L1I_associativity[$L1IAso]}, Block_size = ${SizeofBlock[$CBS]}" >> ./m5out/output.txt
